...
SCHEMA_FILE    = os.path.join(os.path.dirname(__file__), "graph_schema.md")
FAILURE_LOG    = os.path.join(os.path.dirname(__file__), "failure_cases.md")
...
def ask(question: str, client: anthropic.Anthropic, schema: str, debug: bool = True) -> None:
    print(f"\nQuestion: {question}")
    print("─" * 60)
